# Fix Plan Supplement (fix-plan phase override for `/writing-plans`)

**Invoked by:** diagnose `SKILL.md`, fix-plan phase (INVOKE 1 = Read this file; INVOKE 2 = `/writing-plans`).
...
```
docs/features/<YYYY-MM-DD-topic>/fix-plan.md
```
...
- `docs/features/<YYYY-MM-DD-topic>/rca-report.md` (produced by the rca phase)
